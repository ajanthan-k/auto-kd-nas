...
#     # Attention Heads
#     attn_heads = getattr(teacher_config, 'num_attention_heads', 12)
...
#     # Hidden Layers
#     hidden_layers = getattr(teacher_config, 'num_hidden_layers', 12)
...
#     # Hidden Size
#     # allow hidden sizes divisible by any head option
#     h_size_options = set()
#     default_head_dim = 64 # default
